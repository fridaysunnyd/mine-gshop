  ...
  <div>
    <div class="goods">
      <div class="menu-wrapper">
        <ul ref="leftUl">
          <li class="menu-item" v-for="(c,index) in shopGoods" :key="index"
              :class="{current: index===currentIndex}"
              @click="clickLeftItem(index)">
            <span class="text bottom-border-1px">
              <img class="icon" v-if="c.icon" :src="c.icon">
              {{c.name}}
            </span>
          </li>
        </ul>
      ...
      <div class="foods-wrapper">
        <ul ref="rightUl">
          <li class="food-list-hook" v-for="(c,index) in shopGoods" :key="index">
